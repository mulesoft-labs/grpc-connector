...
@Alias("On-LoadCache")
@EmitsResponse
public class GrpcLoadCacheMessageReceiver extends Source<InputStream, Map<String, String>> {
    Logger logger = LoggerFactory.getLogger(GrpcLoadCacheMessageReceiver.class);
    @Config
    ...
    public void onStart(SourceCallback<InputStream, Map<String, String>> sourceCallback) throws MuleException {
        ...
        connection.getExchangeMessage().setOnLoadCacheSourceCallBack(sourceCallback);
    }
