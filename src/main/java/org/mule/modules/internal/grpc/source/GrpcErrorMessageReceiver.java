...
@Alias("On-Error")
@EmitsResponse
public class GrpcErrorMessageReceiver extends Source<InputStream, Map<String, String>> {
    Logger logger = LoggerFactory.getLogger(GrpcErrorMessageReceiver.class);
    @Config
    ...
    public void onStart(SourceCallback<InputStream, Map<String, String>> sourceCallback) throws MuleException {
        ...
        connection.getExchangeMessage().setOnErrorMessageReceiverSourceCallBack(sourceCallback);
    }
