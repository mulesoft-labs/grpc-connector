...
@MediaType(ANY)
@Alias("On-Receive-Message")
@EmitsResponse
public class GrpcMessageReceiver extends Source<InputStream, Map<String, String>> {
    Logger logger = LoggerFactory.getLogger(GrpcMessageReceiver.class);
    ...
    public void onStart(SourceCallback<InputStream, Map<String, String>> sourceCallback) throws MuleException {
        ...
        connection.getExchangeMessage().setMessageReceiverSourceCallBack(sourceCallback);
