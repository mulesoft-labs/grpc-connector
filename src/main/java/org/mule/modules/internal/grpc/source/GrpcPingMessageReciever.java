...
@Alias("On-Ping")
@EmitsResponse
public class GrpcPingMessageReciever extends Source<InputStream, Map<String, String>> {
    Logger logger = LoggerFactory.getLogger(GrpcPingMessageReciever.class);
    @Config
    ...
    public void onStart(SourceCallback<InputStream, Map<String, String>> sourceCallback) throws MuleException {
        ...
        connection.getExchangeMessage().setOnPingSourceCallBack(sourceCallback);
    }

    public GrpcPingMessageReciever() {
        super();
    }
